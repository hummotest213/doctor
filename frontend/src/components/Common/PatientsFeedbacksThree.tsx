...
function PatientsFeedbacksThree({
  ...
  return (
    <>
      <div className="feedback-area ptb-140 wrap-style2">
        <div className="container">
          <div className="section-title">
            <div className="row justify-content-center align-items-center g-4">
              <div className="col-lg-6 col-md-12">
                <div className="left">
                  <span className="sub">Patients Feedbacks</span>
          ...
          <div className="feedback-wrap-inner wrap2">
            <div className="row justify-content-center align-items-center">
              <div className="col-xl-4 col-md-12">
                <div className="feedback-rating-box">
                  ...
                  <div className="wrap-shape">
                    <Image
                      src="/images/feedback/shape2.png"
                      alt="image"
                      width={160}
                      height={140}
                    />
              ...
              <div className="col-xl-8 col-md-12">
                <Swiper
                  ...
                  className="feedback-slider style2 style3"
                >
...
export default PatientsFeedbacksThree;
