...
function PatientsFeedbacksTwo({
  ...
  return (
    <>
      <div className="feedback-area wrap-style3">
          ...
          <div className="row justify-content-center align-items-center">
            ...
            <div className="col-xl-8 col-md-12">
              <Swiper
                ...
                className="feedback-slider style3"
              >
                {feedbacks.map((feedback) => (
                  <SwiperSlide key={feedback.id}>
                    <div className="feedback-inner-card wrap2">
...
export default PatientsFeedbacksTwo;
