  ...
  return (
    <>
      ...
      <PageBanner
        ...
        shortText="By using Doutor services, you agree to our terms and conditions. Please review them carefully to understand your rights, responsibilities, and our commitment to providing safe and reliable healthcare."
        homePageUrl="/"
        homePageText="Home"
      ...
      <div className="terms-of-service-area ptb-140">
        <div className="container">
          <div className="terms-of-service-content">
            <p>
              <i>
                This Terms of Service was last updated on September 1, 2025.
              </i>
            </p>
            <h3>
              <span>1.</span> Our Website
            </h3>
            <p>Our website address is: http://doutor.com</p>
